...
export const projects: Project[] = [
  { number: "01", title: "Hotel Booking Platform", category: "Travel technology", year: "2025", description: "A responsive booking journey bringing search, availability, guest management and pricing into one considered experience.", stack: ["Next.js", "TypeScript", "Tailwind", "Supabase"], accent: "hotel" },
