...
/** A secondary surface of the same product that deserves its own card, e.g. the admin panel of a booking platform. */
export type Companion = { number: string; title: string; category: string; year: string; description: string; stack: string[] };
export type Project = { number: string; title: string; category: string; year: string; description: string; stack: string[]; accent: string; githubUrl?: string; caseStudy: CaseStudy; companion?: Companion };
...
export const projects: Project[] = [
  {
    ...
    companion: {
      number: "01A", title: "Hotel System Admin Panel", category: "Admin operations", year: "2026",
      description: "A role-aware admin panel for managing bookings, room inventory, customer data, reporting and access permissions in one operational workspace.",
      stack: ["Admin dashboard", "Analytics", "Access controls"],
    },
    caseStudy: {
      ...
      focus: "Focus — reliable booking workflows, role-aware administration and security-first data handling.",
      sections: [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      focus: "Focus — clean enterprise architecture, configurable access and decision-ready reporting.",
      sections: [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      focus: "Focus — modular restaurant operations, mobile-first service and the Smart Bill Engine for group dining.",
      sections: [
  ...
  },
  {
    ...
    caseStudy: {
      overview: "A personal portfolio designed as an interactive introduction—combining editorial storytelling with a tactile digital identity card.",
      focus: "Focus — visual identity, interaction design and clear presentation of selected work.",
      sections: [
        ...
        { title: "What I built", body: "A responsive portfolio with an interactive lanyard, project galleries and direct pathways to a résumé and professional profiles.", bullets: ["Interactive 3D-inspired lanyard and ID card", "Responsive project showcases and image viewers", "LinkedIn, GitHub and résumé access", "Accessible navigation and reduced-motion support"] },
